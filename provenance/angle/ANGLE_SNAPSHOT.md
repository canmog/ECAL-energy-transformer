...
The `angle-reconstruction-snapshot` branch preserves the synchronized
`angleTransformer` research tree as it stood on 2026-08-17, before selective
integration. This directory carries the curated, machine-readable results into
the integrated branch and ultimately `main`.
